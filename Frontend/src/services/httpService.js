...
export const httpService = axios.create({
    baseURL: '/api/v1', // Removed App.URL
    headers: {
        'Content-Type': 'application/json'
    }
});

// Removed interceptor for setting Authorization header

// Removed interceptor for handling 401 error
...
export function obradiUspjeh(res) {
    console.table(res.data); // Modified for logging purposes
